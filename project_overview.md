...
[Minimalist, Scandinavian, Botanical, Industrial, Maximalist, Rustic]
```
...
Step 2: Average all vectors → composite aesthetic profile
        e.g. [0.60, 0.30, 0.10, 0.00, 0.00, 0.00]
        = "60% Minimalist, 30% Scandinavian, 10% Botanical"
...
You will organize images into 6 folders:
```
/data
  /minimalist
  /scandinavian
...
**Q: Why 6 style categories?**
> Based on the most distinct and commonly referenced interior design aesthetics in consumer research and Pinterest taxonomy. Categories were chosen to be visually distinct enough for a CNN to learn meaningful decision boundaries.
